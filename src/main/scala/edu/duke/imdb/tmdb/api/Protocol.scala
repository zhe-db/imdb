...
object Protocol extends DefaultJsonProtocol {
  ...
  final case class AuthenticateResult(
      expires_at: String,
  ...
  final case class Genres(genres: Seq[Genre])
  ...
  implicit val genresFormat: RootJsonFormat[Genres] = jsonFormat1(Genres)
  ...
  implicit val collectionFormat: RootJsonFormat[Collection] = jsonFormat4(
    Collection
  )
  ...
  implicit val configurationFormat: RootJsonFormat[Configuration] = jsonFormat2(
    Configuration
  )
  implicit val castFormat: RootJsonFormat[Cast] = jsonFormat7(Cast)
  implicit val crewFormat: RootJsonFormat[Crew] = jsonFormat6(Crew)
  implicit val crewDetailFormat: RootJsonFormat[CrewDetail] =
    jsonFormat10(CrewDetail)
